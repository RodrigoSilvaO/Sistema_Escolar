...
--
-- Host: 127.0.0.1
-- Tempo de geração: 20/08/2026 às 17:31
...
--
DROP TRIGGER IF EXISTS `trg_atualiza_resultado_after_delete`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `trg_atualiza_resultado_after_update`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `trg_valida_nota_before_insert`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `trg_valida_nota_before_update`;
DELIMITER $$
...
--
DROP TRIGGER IF EXISTS `trg_valida_frequencia_ferias`;
DELIMITER $$
...
--
ALTER TABLE `avaliacao`
  MODIFY `id_boletim` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT de tabela `disciplina`
--
ALTER TABLE `disciplina`
  MODIFY `id_disciplina` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;

--
-- AUTO_INCREMENT de tabela `especialidade_professor`
--
ALTER TABLE `especialidade_professor`
  MODIFY `id_especialidade` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
...
--
ALTER TABLE `registro_frequencia`
  MODIFY `id_frequencia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
